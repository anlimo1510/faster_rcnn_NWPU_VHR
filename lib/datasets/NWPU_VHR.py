...
import subprocess
import uuid
from datasets.NWPU_VHR_eval import voc_eval
import datasets.annotation_parser_for_NWPU_VHR as ap
...
class NWPU_VHR(imdb):
    def __init__(self, image_set):
        ...
        if image_set == 'train':
            self._data_path = os.path.join("/home/faster_rcnn_NWPU_VHR/data/NWPU_VHR") # recommend the top directory
        elif image_set == 'test': 
            self._data_path = os.path.join("/home/faster_rcnn_NWPU_VHR/data/NWPU_VHR")
