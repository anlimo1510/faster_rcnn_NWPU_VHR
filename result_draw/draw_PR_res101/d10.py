...
fr = open('./res101_faster_rcnn_iter_10000/vehicle_pr.pkl','rb')
inf = pickle.load(fr)
fr.close()
...
fr = open('./res101_faster_rcnn_iter_20000/vehicle_pr.pkl','rb')
inf = pickle.load(fr)
fr.close()
...
fr = open('./res101_faster_rcnn_iter_25000/vehicle_pr.pkl','rb')
inf = pickle.load(fr)
fr.close()
...
fr = open('./res101_faster_rcnn_iter_30000/vehicle_pr.pkl','rb')
inf = pickle.load(fr)
fr.close()
...
fr = open('./res101_faster_rcnn_iter_40000/vehicle_pr.pkl','rb')
inf = pickle.load(fr)
fr.close()
...
plt.title('(10) vehicle')
plt.xlim((-0.02,1.02))
plt.ylim((-0.02,1.02))
plt.savefig('./PR/vehicle_pr.png')
