...
fr = open('./res101_faster_rcnn_iter_10000/baseball diamond_pr.pkl','rb')
inf = pickle.load(fr)
fr.close()
...
fr = open('./res101_faster_rcnn_iter_20000/baseball diamond_pr.pkl','rb')
inf = pickle.load(fr)
fr.close()
...
fr = open('./res101_faster_rcnn_iter_25000/baseball diamond_pr.pkl','rb')
inf = pickle.load(fr)
fr.close()
...
fr = open('./res101_faster_rcnn_iter_30000/baseball diamond_pr.pkl','rb')
inf = pickle.load(fr)
fr.close()
...
fr = open('./res101_faster_rcnn_iter_40000/baseball diamond_pr.pkl','rb')
inf = pickle.load(fr)
fr.close()
...
plt.xlim((-0.02,1.02))
plt.ylim((-0.02,1.02))
plt.title('(2) baseball diamond')
plt.savefig('./PR/baseball diamond_pr.png')
