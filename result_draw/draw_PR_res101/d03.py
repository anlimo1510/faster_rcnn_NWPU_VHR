...
fr = open('./res101_faster_rcnn_iter_10000/basketball court_pr.pkl','rb')
inf = pickle.load(fr)
fr.close()
...
fr = open('./res101_faster_rcnn_iter_20000/basketball court_pr.pkl','rb')
inf = pickle.load(fr)
fr.close()
...
fr = open('./res101_faster_rcnn_iter_25000/basketball court_pr.pkl','rb')
inf = pickle.load(fr)
fr.close()
...
fr = open('./res101_faster_rcnn_iter_30000/basketball court_pr.pkl','rb')
inf = pickle.load(fr)
fr.close()
...
fr = open('./res101_faster_rcnn_iter_40000/basketball court_pr.pkl','rb')
inf = pickle.load(fr)
fr.close()
...
plt.xlim((-0.02,1.02))
plt.ylim((-0.02,1.02))
plt.title('(3) basketball court')
plt.savefig('./PR/basketball court_pr.png')
