...
fr = open('./res101_faster_rcnn_iter_10000/ground track field_pr.pkl','rb')
inf = pickle.load(fr)
fr.close()
...
fr = open('./res101_faster_rcnn_iter_20000/ground track field_pr.pkl','rb')
inf = pickle.load(fr)
fr.close()
...
fr = open('./res101_faster_rcnn_iter_25000/ground track field_pr.pkl','rb')
inf = pickle.load(fr)
fr.close()
...
fr = open('./res101_faster_rcnn_iter_30000/ground track field_pr.pkl','rb')
inf = pickle.load(fr)
fr.close()
...
fr = open('./res101_faster_rcnn_iter_40000/ground track field_pr.pkl','rb')
inf = pickle.load(fr)
fr.close()
...
plt.title('(5) ground track field')
plt.xlim((-0.02,1.02))
plt.ylim((-0.02,1.02))
plt.savefig('./PR/ground track field_pr.png')
