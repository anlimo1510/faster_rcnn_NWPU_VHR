...
fr = open('./res101_faster_rcnn_iter_10000/tennis court_pr.pkl','rb')
inf = pickle.load(fr)
fr.close()
...
fr = open('./res101_faster_rcnn_iter_20000/tennis court_pr.pkl','rb')
inf = pickle.load(fr)
fr.close()
...
fr = open('./res101_faster_rcnn_iter_25000/tennis court_pr.pkl','rb')
inf = pickle.load(fr)
fr.close()
...
fr = open('./res101_faster_rcnn_iter_30000/tennis court_pr.pkl','rb')
inf = pickle.load(fr)
fr.close()
...
fr = open('./res101_faster_rcnn_iter_40000/tennis court_pr.pkl','rb')
inf = pickle.load(fr)
fr.close()
...
plt.title('(9) tennis court')
plt.xlim((-0.02,1.02))
plt.ylim((-0.02,1.02))
plt.savefig('./PR/tennis court_pr.png')
