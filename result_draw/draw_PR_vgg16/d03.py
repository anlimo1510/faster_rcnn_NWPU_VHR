...
fr = open('./vgg16_faster_rcnn_iter_10000/basketball court_pr.pkl','rb')
inf = pickle.load(fr)
fr.close()
...
fr = open('./vgg16_faster_rcnn_iter_20000/basketball court_pr.pkl','rb')
inf = pickle.load(fr)
fr.close()
...
fr = open('./vgg16_faster_rcnn_iter_25000/basketball court_pr.pkl','rb')
inf = pickle.load(fr)
fr.close()
...
fr = open('./vgg16_faster_rcnn_iter_30000/basketball court_pr.pkl','rb')
inf = pickle.load(fr)
fr.close()
...
fr = open('./vgg16_faster_rcnn_iter_40000/basketball court_pr.pkl','rb')
inf = pickle.load(fr)
fr.close()
