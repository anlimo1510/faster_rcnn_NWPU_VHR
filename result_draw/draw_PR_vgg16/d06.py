...
fr = open('./vgg16_faster_rcnn_iter_10000/harbor_pr.pkl','rb')
inf = pickle.load(fr)
fr.close()
...
fr = open('./vgg16_faster_rcnn_iter_20000/harbor_pr.pkl','rb')
inf = pickle.load(fr)
fr.close()
...
fr = open('./vgg16_faster_rcnn_iter_25000/harbor_pr.pkl','rb')
inf = pickle.load(fr)
fr.close()
...
fr = open('./vgg16_faster_rcnn_iter_30000/harbor_pr.pkl','rb')
inf = pickle.load(fr)
fr.close()
...
fr = open('./vgg16_faster_rcnn_iter_40000/harbor_pr.pkl','rb')
inf = pickle.load(fr)
fr.close()
